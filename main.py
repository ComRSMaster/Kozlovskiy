...
from functions.chat_cmd import register_chat_handlers
...
def query(call: CallbackQuery):
        ...
        bot.edit_message_text(book_orig_text, call.message.chat.id, call.message.message_id,
                              reply_markup=books_home_markup)
